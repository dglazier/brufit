{
  ...
  Generator.SetUp().SetOutDir("genBruAmpsCirc/");
  ...
  config.SetPolCirc("CircPol[0.7,0,1.0001.]");
  config.SetBeamHelicity("Heli[1,-1.0001,1.0001.]");
  Generator.SetUp().SetDataOnlyCut("Heli!=0");


  //if polarisation has fixed value
  //config.SetConstPolarisation("Pol[0.5]");
