  ...
  namespace FIT{
   ...
   ComponentsPdfParser PolarisedSphHarmonicMoments(TString name,TString cth,TString phi,TString phiPol,TString Pol,Int_t Lmax,Int_t Mmin,Int_t Mmax){
      ...
      return mp;
       ...
       //e.g.PolarisedSphHarmonicMoments("Moments","CosTh","Phi","PolPhi","Pol",3,2);
    ComponentsPdfParser WignerDFunctionMoments(TString name,TString cth,TString phi,Int_t Lmax,Int_t Mmin,Int_t Mmax,Int_t Nmin,Int_t Nmax){
      ComponentsPdfParser mp(name.Data());
      mp.SetVars(Form("%s,%s",cth.Data(),phi.Data()));
   ...
   ComponentsPdfParser WignerDFunctionProductMoments(TString name,TString cth1,TString phi1,TString cth2,TString phi2,Int_t Lmax1,Int_t Mmin1,Int_t Mmax1,Int_t Nmin1,Int_t Nmax1,Int_t Lmax2){
     ...
     Int_t Mmax2=Nmax1;
      ...
      TString theta1= Form("ThetaFrom%s",cth1.Data());
      TString theta2= Form("ThetaFrom%s",cth2.Data());
      ...
      mp.ConstructPDF(mp.ReplaceSummations(Form("SUM(L[0|%d],M[%d|%d>-L-1<L+1],N[%d|%d>-L-1<L+1],l[0|%d<L+1]){Dab_L_M_N_l(Da_L_M_N,Db_l_N_0)}",Lmax1,Mmin1,Mmax1,Nmin1,Nmax1,Lmax2)));
      
      mp.AddFormula(Form("%s=TMath::ACos(@%s[])",theta1.Data(),cth1.Data()));
      mp.AddFormula(Form("%s=TMath::ACos(@%s[])",theta2.Data(),cth2.Data()));
