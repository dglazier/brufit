...
//       // --- NEW FIXES ---
//       Bool_t _inValley = kFALSE; // Tracks if the algorithm is stuck in a highly correlated valley
//       std::vector<RooRealVar*> _varCache; // Fast C++ pointer cache to bypass ROOT iteration overhead
//       // -----------------
