...
/*     protected: */
/*         std::shared_ptr<const MCEventCache> _DataCache; //! Thread-safe, read-only cache */
...
/*         // BUG FIX: Must default to FALSE to ensure integration runs */
/*         Bool_t _ForceConstInt = kFALSE;  */
/*         Bool_t _ForceNumInt = kFALSE; */
/*         Bool_t _UseWeightsGen = kFALSE; */
...
/*         std::vector<Double_t> _AssertPosDataReal; */
/*         std::vector<Int_t> _AssertPosDataCats; */
/*         Long64_t _Napd = 10000; */
...
/*         // Configuration state for building the Cache */
/*         TString _TruthPrefix = "gen"; */
/*         HS::FIT::WeightsConfig _WgtsConf; */
/*         TString _Cut;  */
/*         TString _InWeightCut;  */
...
/*         // BUG FIX: Tracks variables missing from MC Tree to safely AddProtoData */
/*         std::vector<TString> _ProtoRealVars; */
/*         std::vector<TString> _ProtoCatVars; */
...
/*             _WgtsConf.Copy(wcon); */
/*         } */
/*         Bool_t SetEvTree(TTree* tree, TString cut, TTree* MCGenTree = nullptr); */
...
/*         virtual Double_t evaluateMC(const std::vector<Double_t> *vars, const std::vector<Int_t> *cats) const { return 0.; } */
