  ...
  namespace FIT{
    ...
    public:
      ...
      Bool_t CheckStepSize(Float_t acceptance) override {
        ...
        // Let the base class calculate the new fScale
    ...
    private:
      TMatrixDSym _baseMatrix; // The unscaled, raw covariance matrix
      TMatrixDSym _covMatrix;  // The scaled matrix
      TMatrixD _lMatrix;       // The Lower Triangular Cholesky Matrix

      RooArgList _xVec;
      std::vector<RooRealVar*> _varCache; // Fast C++ pointer cache
